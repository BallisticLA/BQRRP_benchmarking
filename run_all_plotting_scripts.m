...
bqrrp_speed_comparisons_mat_size_rectangle_cpu(filename1, filename2, fig_path, 8000, 4000, 4, 3, 7, show_lables);

figure('Name', 'fig_17_bqrrp_performance_varying_block_size_small_inputs', 'NumberTitle', 'off');
